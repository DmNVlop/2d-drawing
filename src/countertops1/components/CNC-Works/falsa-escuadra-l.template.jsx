...
function FalsaEscuadraCNCWorkL(props) {
  ...
  return (
    <Group>
      {workData.type == WORKS_TYPES.CCFALESC && (
...
export default FalsaEscuadraCNCWorkL;

FalsaEscuadraCNCWorkL.propTypes = {
  workData: PropTypes.object,
  pieceSelected: PropTypes.object,
  indexPiece: PropTypes.number,
};
