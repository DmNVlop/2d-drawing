...
export default function ImportDXFShapePage(props) {
  const { title } = props;

  const { ATTRIB_SETTED } = useCustomURLHandler();
  console.log("🚀 ~ ImportDXFShapePage ~ ATTRIB_SETTED:", ATTRIB_SETTED);
  ...
  return (
    <section id="importdxf-shape-page">
      <Row gutter={[8]} align="middle" justify="flex-start">
        ...
        <Col className="guttter-row" style={{ height: "40px" }}>
          <figure className="ct-figure-on-title">
            <img src="/images/jobs/import-DXF.png" alt={pageTitle} />
          </figure>
        </Col>
