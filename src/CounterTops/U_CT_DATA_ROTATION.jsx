...
export const UctDataRotation_L1 = (
  tempData,
  directionRotation,
  arrayPosition
) => {
  const configData = {
    ...
    counterclockwise: () => {
      ...
      tempData[arrayPosition].rotation = 90;
      tempData[arrayPosition].xGroup =
        tempData[0].height * SCREEN_MULIPLY +
        tempData[1].width * SCREEN_MULIPLY +
        tempData[arrayPosition].height * SCREEN_MULIPLY +
        INIT_SHAPE_POINTS.x * 2;
      tempData[arrayPosition].yGroup = 0;
      tempData[arrayPosition].xLayer = 0;
      tempData[arrayPosition].yLayer = 0;
    },
...
export const UctDataRotation_L2 = (
  tempData,
  directionRotation,
  arrayPosition
) => {
...
export const UctDataRotation_L3 = (
  tempData,
  directionRotation,
  arrayPosition
) => {
  const configData = {
    ...
    counterclockwise: () => {
      ...
      tempData[arrayPosition].xGroup =
        ...
        tempData[1].width * SCREEN_MULIPLY +
        INIT_SHAPE_POINTS.x * 2;
      tempData[arrayPosition].yGroup = tempData[1].height * SCREEN_MULIPLY;
      tempData[arrayPosition].xLayer = 0;
      tempData[arrayPosition].yLayer = 0;
    },
  };
...
export const UctDataRotation_L4 = (
  tempData,
  directionRotation,
  arrayPosition
) => {
  const configData = {
    ...
    counterclockwise: () => {
      ...
      tempData[arrayPosition].rotation = 90;
      tempData[arrayPosition].xGroup =
        tempData[1].width * SCREEN_MULIPLY + INIT_SHAPE_POINTS.x * 2;
      tempData[arrayPosition].yGroup = tempData[1].height * SCREEN_MULIPLY;
      tempData[arrayPosition].xLayer = 0;
      tempData[arrayPosition].yLayer = 0;
    },
